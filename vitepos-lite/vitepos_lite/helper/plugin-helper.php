...
if ( ! function_exists( 'vitepos_get_product_cart_item' ) ) {
	...
	function vitepos_get_product_cart_item( $product_id ) {
		...
		if ( ! empty( $product ) ) {
			...
			if ( ! apply_filters( 'woocommerce_prices_include_tax', get_option( 'woocommerce_prices_include_tax' ) === 'yes' ) ) {
				...
				vtp_product_tax_rates( $cart_item );
			}
			return $cart_item;
		}
